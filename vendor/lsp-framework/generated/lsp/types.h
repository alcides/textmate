...
/*
 * textDocument/implementationResult
 */
using TextDocumentImplementationResult = NullOrOneOf<Definition, Array<DefinitionLink>>;

/*
 * textDocument/implementationPartialResult
 */
using TextDocumentImplementationPartialResult = OneOf<Array<Location>, Array<DefinitionLink>>;

/*
 * textDocument/typeDefinitionResult
 */
using TextDocumentTypeDefinitionResult = NullOrOneOf<Definition, Array<DefinitionLink>>;

/*
 * textDocument/typeDefinitionPartialResult
 */
using TextDocumentTypeDefinitionPartialResult = OneOf<Array<Location>, Array<DefinitionLink>>;

/*
 * workspace/workspaceFoldersResult
 */
using WorkspaceWorkspaceFoldersResult = NullOr<Array<WorkspaceFolder>>;

/*
 * workspace/configurationResult
 */
using WorkspaceConfigurationResult = LSPArray;

/*
 * textDocument/documentColorResult
 */
using TextDocumentDocumentColorResult = Array<ColorInformation>;

/*
 * textDocument/documentColorPartialResult
 */
using TextDocumentDocumentColorPartialResult = Array<ColorInformation>;

/*
 * textDocument/colorPresentationResult
 */
using TextDocumentColorPresentationResult = Array<ColorPresentation>;

/*
 * textDocument/colorPresentationPartialResult
 */
using TextDocumentColorPresentationPartialResult = Array<ColorPresentation>;

/*
 * textDocument/foldingRangeResult
 */
using TextDocumentFoldingRangeResult = NullOr<Array<FoldingRange>>;

/*
 * textDocument/foldingRangePartialResult
 */
using TextDocumentFoldingRangePartialResult = Array<FoldingRange>;

/*
 * workspace/foldingRange/refreshResult
 */
using WorkspaceFoldingRangeRefreshResult = Null;

/*
 * textDocument/declarationResult
 */
using TextDocumentDeclarationResult = NullOrOneOf<Declaration, Array<DeclarationLink>>;

/*
 * textDocument/declarationPartialResult
 */
using TextDocumentDeclarationPartialResult = OneOf<Array<Location>, Array<DeclarationLink>>;

/*
 * textDocument/selectionRangeResult
 */
using TextDocumentSelectionRangeResult = NullOr<Array<SelectionRange>>;

/*
 * textDocument/selectionRangePartialResult
 */
using TextDocumentSelectionRangePartialResult = Array<SelectionRange>;

/*
 * window/workDoneProgress/createResult
 */
using WindowWorkDoneProgressCreateResult = Null;

/*
 * textDocument/prepareCallHierarchyResult
 */
using TextDocumentPrepareCallHierarchyResult = NullOr<Array<CallHierarchyItem>>;

/*
 * callHierarchy/incomingCallsResult
 */
using CallHierarchyIncomingCallsResult = NullOr<Array<CallHierarchyIncomingCall>>;

/*
 * callHierarchy/incomingCallsPartialResult
 */
using CallHierarchyIncomingCallsPartialResult = Array<CallHierarchyIncomingCall>;

/*
 * callHierarchy/outgoingCallsResult
 */
using CallHierarchyOutgoingCallsResult = NullOr<Array<CallHierarchyOutgoingCall>>;

/*
 * callHierarchy/outgoingCallsPartialResult
 */
using CallHierarchyOutgoingCallsPartialResult = Array<CallHierarchyOutgoingCall>;

/*
 * textDocument/semanticTokens/fullResult
 */
using TextDocumentSemanticTokensFullResult = NullOr<SemanticTokens>;

/*
 * textDocument/semanticTokens/full/deltaResult
 */
using TextDocumentSemanticTokensFullDeltaResult = NullOrOneOf<SemanticTokens, SemanticTokensDelta>;

/*
 * textDocument/semanticTokens/full/deltaPartialResult
 */
using TextDocumentSemanticTokensFullDeltaPartialResult = OneOf<SemanticTokensPartialResult, SemanticTokensDeltaPartialResult>;

/*
 * textDocument/semanticTokens/rangeResult
 */
using TextDocumentSemanticTokensRangeResult = NullOr<SemanticTokens>;

/*
 * workspace/semanticTokens/refreshResult
 */
using WorkspaceSemanticTokensRefreshResult = Null;

/*
 * textDocument/linkedEditingRangeResult
 */
using TextDocumentLinkedEditingRangeResult = NullOr<LinkedEditingRanges>;

/*
 * workspace/willCreateFilesResult
 */
using WorkspaceWillCreateFilesResult = NullOr<WorkspaceEdit>;

/*
 * workspace/willRenameFilesResult
 */
using WorkspaceWillRenameFilesResult = NullOr<WorkspaceEdit>;

/*
 * workspace/willDeleteFilesResult
 */
using WorkspaceWillDeleteFilesResult = NullOr<WorkspaceEdit>;

/*
 * textDocument/monikerResult
 */
using TextDocumentMonikerResult = NullOr<Array<Moniker>>;

/*
 * textDocument/monikerPartialResult
 */
using TextDocumentMonikerPartialResult = Array<Moniker>;

/*
 * textDocument/prepareTypeHierarchyResult
 */
using TextDocumentPrepareTypeHierarchyResult = NullOr<Array<TypeHierarchyItem>>;

/*
 * typeHierarchy/supertypesResult
 */
using TypeHierarchySupertypesResult = NullOr<Array<TypeHierarchyItem>>;

/*
 * typeHierarchy/supertypesPartialResult
 */
using TypeHierarchySupertypesPartialResult = Array<TypeHierarchyItem>;

/*
 * typeHierarchy/subtypesResult
 */
using TypeHierarchySubtypesResult = NullOr<Array<TypeHierarchyItem>>;

/*
 * typeHierarchy/subtypesPartialResult
 */
using TypeHierarchySubtypesPartialResult = Array<TypeHierarchyItem>;

/*
 * textDocument/inlineValueResult
 */
using TextDocumentInlineValueResult = NullOr<Array<InlineValue>>;

/*
 * textDocument/inlineValuePartialResult
 */
using TextDocumentInlineValuePartialResult = Array<InlineValue>;

/*
 * workspace/inlineValue/refreshResult
 */
using WorkspaceInlineValueRefreshResult = Null;

/*
 * textDocument/inlayHintResult
 */
using TextDocumentInlayHintResult = NullOr<Array<InlayHint>>;

/*
 * textDocument/inlayHintPartialResult
 */
using TextDocumentInlayHintPartialResult = Array<InlayHint>;

/*
 * workspace/inlayHint/refreshResult
 */
using WorkspaceInlayHintRefreshResult = Null;

/*
 * workspace/diagnostic/refreshResult
 */
using WorkspaceDiagnosticRefreshResult = Null;

/*
 * textDocument/inlineCompletionResult
 */
using TextDocumentInlineCompletionResult = NullOrOneOf<InlineCompletionList, Array<InlineCompletionItem>>;

/*
 * textDocument/inlineCompletionPartialResult
 */
using TextDocumentInlineCompletionPartialResult = Array<InlineCompletionItem>;

/*
 * workspace/textDocumentContent/refreshResult
 */
using WorkspaceTextDocumentContentRefreshResult = Null;

/*
 * client/registerCapabilityResult
 */
using ClientRegisterCapabilityResult = Null;

/*
 * client/unregisterCapabilityResult
 */
using ClientUnregisterCapabilityResult = Null;
...
/*
 * window/showMessageRequestResult
 */
using WindowShowMessageRequestResult = NullOr<MessageActionItem>;

/*
 * textDocument/willSaveWaitUntilResult
 */
using TextDocumentWillSaveWaitUntilResult = NullOr<Array<TextEdit>>;

/*
 * textDocument/completionResult
 */
using TextDocumentCompletionResult = NullOrOneOf<Array<CompletionItem>, CompletionList>;

/*
 * textDocument/completionPartialResult
 */
using TextDocumentCompletionPartialResult = Array<CompletionItem>;

/*
 * textDocument/hoverResult
 */
using TextDocumentHoverResult = NullOr<Hover>;

/*
 * textDocument/signatureHelpResult
 */
using TextDocumentSignatureHelpResult = NullOr<SignatureHelp>;

/*
 * textDocument/definitionResult
 */
using TextDocumentDefinitionResult = NullOrOneOf<Definition, Array<DefinitionLink>>;

/*
 * textDocument/definitionPartialResult
 */
using TextDocumentDefinitionPartialResult = OneOf<Array<Location>, Array<DefinitionLink>>;

/*
 * textDocument/referencesResult
 */
using TextDocumentReferencesResult = NullOr<Array<Location>>;

/*
 * textDocument/referencesPartialResult
 */
using TextDocumentReferencesPartialResult = Array<Location>;

/*
 * textDocument/documentHighlightResult
 */
using TextDocumentDocumentHighlightResult = NullOr<Array<DocumentHighlight>>;

/*
 * textDocument/documentHighlightPartialResult
 */
using TextDocumentDocumentHighlightPartialResult = Array<DocumentHighlight>;

/*
 * textDocument/documentSymbolResult
 */
using TextDocumentDocumentSymbolResult = NullOrOneOf<Array<SymbolInformation>, Array<DocumentSymbol>>;

/*
 * textDocument/documentSymbolPartialResult
 */
using TextDocumentDocumentSymbolPartialResult = OneOf<Array<SymbolInformation>, Array<DocumentSymbol>>;

/*
 * textDocument/codeActionResult
 */
using TextDocumentCodeActionResult = NullOr<Array<OneOf<Command, CodeAction>>>;
// Local compatibility fix: both alternatives have title/command keys, but
// Command.command is a string and CodeAction.command is an object.
void fromJson(json::Value&& json, OneOf<Command, CodeAction>& value);

/*
 * textDocument/codeActionPartialResult
 */
using TextDocumentCodeActionPartialResult = Array<OneOf<Command, CodeAction>>;

/*
 * workspace/symbolResult
 */
using WorkspaceSymbolResult = NullOrOneOf<Array<SymbolInformation>, Array<WorkspaceSymbol>>;

/*
 * workspace/symbolPartialResult
 */
using WorkspaceSymbolPartialResult = OneOf<Array<SymbolInformation>, Array<WorkspaceSymbol>>;

/*
 * textDocument/codeLensResult
 */
using TextDocumentCodeLensResult = NullOr<Array<CodeLens>>;

/*
 * textDocument/codeLensPartialResult
 */
using TextDocumentCodeLensPartialResult = Array<CodeLens>;

/*
 * workspace/codeLens/refreshResult
 */
using WorkspaceCodeLensRefreshResult = Null;

/*
 * textDocument/documentLinkResult
 */
using TextDocumentDocumentLinkResult = NullOr<Array<DocumentLink>>;

/*
 * textDocument/documentLinkPartialResult
 */
using TextDocumentDocumentLinkPartialResult = Array<DocumentLink>;

/*
 * textDocument/formattingResult
 */
using TextDocumentFormattingResult = NullOr<Array<TextEdit>>;

/*
 * textDocument/rangeFormattingResult
 */
using TextDocumentRangeFormattingResult = NullOr<Array<TextEdit>>;

/*
 * textDocument/rangesFormattingResult
 */
using TextDocumentRangesFormattingResult = NullOr<Array<TextEdit>>;

/*
 * textDocument/onTypeFormattingResult
 */
using TextDocumentOnTypeFormattingResult = NullOr<Array<TextEdit>>;

/*
 * textDocument/renameResult
 */
using TextDocumentRenameResult = NullOr<WorkspaceEdit>;

/*
 * textDocument/prepareRenameResult
 */
using TextDocumentPrepareRenameResult = NullOr<PrepareRenameResult>;

/*
 * workspace/executeCommandResult
 */
using WorkspaceExecuteCommandResult = NullOr<LSPAny>;
